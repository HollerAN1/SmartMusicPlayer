...
//        RoomSQLDatabase db = RoomSQLDatabase.getDatabase(context);
//        mSongDao = db.songDao();
...
//    }
//
//    public int getNumberOfSongsStoredOnDevice(){
...
//    }
//
//    public LiveData<List<Song>> getAllSongsForAlbum(String albumUID){
//        return mAlbumDao.getSongsForAlbum(albumUID);
//    }
//
//
//
